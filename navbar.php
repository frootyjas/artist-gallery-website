...
<body>
    <div class="navbar">
        <div class="logo">
            <img src="images/logo-black.png" alt="Logo" id="navbar-logo">
        </div>
        <div class="nav-links">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="#change-theme" id="theme-toggle"><i class="fas fa-paint-brush"></i> Change Theme</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            themeToggle.addEventListener('click', function() {
                ...
                var dropdownContentLinks = document.querySelectorAll('.dropdown-content a');
